...
//删除待审核点位
function delete_addlayer(data) {
    return defalut_request('delete', `http://api.yuanshen.site:8089/api/verify/`, data)
}
export { addlayer_handle, select_addlayer, delete_addlayer }